...
class HybGNN(torch.nn.Module):
    ...
    def setup_layers(self):
        ...
        self.convolution_1 = GCNConv(self.embed_dim, self.args.filters_1).to(device)
...
class HybGNNTrainer(object):
    ...
    def initial_label_enumeration(self):
        ...
        print("aftersorted_train_labels", self.aftersorted_train_labels)
    ...
    def transfer_trainset_to_torch(self, traindata):
        ...
        for n in traindata["labels_1"]:
            # print("n: ", n)
            # print("features_1: ", [1.0 if self.aftersorted_train_labels[n] == i else 0.0 for i in self.aftersorted_train_labels.values()] + [0] * (self.number_of_labels - self.train_number_of_labels))
        ...
        print("features_1 size:", features_1.size())


        norm_ged = traindata["ged"]/(len(traindata["labels_1"]))
        
        print("ged", traindata["ged"])
        print("len", len(traindata["labels_1"]))
        print("norm_ged", norm_ged)
