"""_Introgression_sim_and_verify.py_

The simulation and data-saving process of introgression data
...
from simulation_models import introgression
import numpy as np
import tskit
...
current_folder = '0907_introgression'
...
if __name__ == "__main__":
    ...
    parser = argparse.ArgumentParser(
        description="Options for Introgression_simulation_and_verify.py", add_help=True)
    ...
    print("The current simulation is Introgression data.", flush=True)
    ...
    df_config = pd.DataFrame(columns=['time_units', 'length', 't1','t2', 't3', 
                                      'recomb_rate', 'mutate_rate', "intro_timet0", "intro_ratio",
    ...
    print(f"The simulation of {run_nums} {cu_part} introgression data is done.\n")
