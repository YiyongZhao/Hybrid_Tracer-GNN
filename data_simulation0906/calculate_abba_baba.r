...
blocks = get_genome_blocks(block_size=2e4, lg_lengths=lg_lengths) # seqlength is shorter now, 2e5, but 1e4 is slow
...
# Feedback.
write(paste("D-zscore: ", D_Z, sep=""), output_file, append=T)
write(paste("D-pvalue: ", D_p, sep=""), output_file, append=T)
