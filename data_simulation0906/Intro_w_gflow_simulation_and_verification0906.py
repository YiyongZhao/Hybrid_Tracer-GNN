"""_Intro_w_gflow_sim_and_verify.py_

The simulation and data-saving process of introgression with gene flow data
...
from simulation_models import introgression_w_gflow
import numpy as np
import tskit
...
current_folder = '0907_intro_w_gflow'
...
if __name__ == "__main__":
    ...
    parser = argparse.ArgumentParser(
        description="Options for Intro_w_gflow_simulation_and_verify.py", add_help=True)
    ...
    print("The current simulation is Intro_w_gflow data.", flush=True)
    ...
    df_config = pd.DataFrame(columns=['time_units', 'length', 't1','t2', 't3', 
                                      'recomb_rate', 'mutate_rate', "intro_timet0", "intro_ratio","m_rate",
    ...
    print(f"The simulation of {run_nums} {cu_part} intro_w_gflow data is done.\n")
